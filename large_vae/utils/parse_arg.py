...
def parse_arguments():
    ...
    #+- Training +-#
    parser.add_argument("--epochs", type=pos_num,default=3000, help="number of epochs to use during the training")
    parser.add_argument("--batch_size", type=pos_num,default=128, help="batch size to use for training")
    parser.add_argument("--lr", type=float, default=0.000005,help="learning rate of the learning process" )
    ...
    parser.add_argument("--pseudoinputs_mean", type=float, default=-0.05, help='mean for the pseudoinputs')
    parser.add_argument("--pseudoinputs_std", type=float, default=0.01, help='stddev for the pseudoinputs')
